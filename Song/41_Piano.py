...
posVal = Library.pos2Dec([0, 8 ]);
e5 = 2.0
#client.send_message("/synth/piano", [0.2, 164.81/110.0, posVal, posVal, posVal, posVal, numPhrase])
if stopNum == 0:
    client.send_message("/song/synth/piano", [0.22*0.35*playVolume, e5 * freqRatio, maskArray[3]*posVal, maskArray[2]*posVal, maskArray[1]*posVal, maskArray[0]*posVal, numPhrase])
else:
